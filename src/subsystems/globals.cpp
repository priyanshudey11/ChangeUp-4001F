...
Motor driveLB(3, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_ROTATIONS);
//Right Front
Motor driveRF(4, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_ROTATIONS);
//Right Back
Motor driveRB(6, E_MOTOR_GEARSET_18, false, E_MOTOR_ENCODER_ROTATIONS);
*/
//Intake Right
...
//Middle Intake left
Motor rollert(19, E_MOTOR_GEARSET_06, false, E_MOTOR_ENCODER_ROTATIONS);
//intake in the back
Motor rollerb(9, E_MOTOR_GEARSET_06, false, E_MOTOR_ENCODER_ROTATIONS);
//Controller
